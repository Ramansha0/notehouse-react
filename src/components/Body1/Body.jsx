            ...
            <div className="toge">
              <div className="course1">
                ...
                <img className="a1"
                  ...
                  alt="Math"
                />
                <Link to="/" id="classy1" className="btn btn-secondary" state = {{scrolldown :"nextpage1"}}>Notes</Link>
              </div>
              ...
              <div className="course1">
                ...
                <img className="a1"
                  ...
                  style={{ height: '150px', objectFit: 'contain' }}
                />
                <Link to="/" id="classy3" className="btn btn-secondary"  state = {{scrolldown :"nextpage1"}}>Notes</Link>
              </div>
            </div>
            ...
            <div className="toge1">
              <div className="course1">
                ...
                <img className="a1"
                  ...
                  style={{ height: '150px', objectFit: 'contain' }}
                />
                <Link to="/" id="classy4" className="btn btn-secondary" state = {{scrolldown :"nextpage1"}}>Notes</Link>
              </div>
              ...
              <div className="course1">
                ...
                <Link to="/" id="classy5" className="btn btn-secondary" state = {{scrolldown :"nextpage1"}}>Notes</Link>
              </div>
              ...
              <div className="course1">
                ...
                <img className="a1"
                  ...
                  alt="Computer"
                />
                <Link to="/" id="classy6" className="btn btn-secondary" state = {{scrolldown :"nextpage1"}}>Notes</Link>
              </div>
            </div>
          </div>
        </div>
