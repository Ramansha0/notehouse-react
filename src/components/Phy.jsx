...
const Phy = () => {
    return (
      ...
      <div className="subject">
        <img
          className="glass"
          src="path/to/your/physics-image.png" // Update the image path
          alt="Physics"
        />
        <p className="topic">Physics</p>
      </div>
      <div className="page">
        <div className="three">
          <div className="boxes1">
            <p style={{ marginleft:'-50px' ,fontSize: '20px', fontWeight: '600', textAlign: 'center', paddingTop: '10px' }}>
              NEB CLASS - XI All Physics Notes
            </p>
            <p style={{ fontSize: '14px', paddingLeft: '32px', paddingRight: '20px', marginTop: '-15px' }}>
              Here you can find almost every revised note of physics.
            </p>
            <p style={{ fontSize: '9px', paddingLeft: '32px', marginTop: '-4px' }}>Batch - 2081</p>
          </div>
          <div style={{ marginTop: '30px' }} className="boxes1">
            <p style={{ fontSize: '20px', fontWeight: '600', textAlign: 'center', paddingTop: '10px' }}>
          ...
          <div style={{ marginTop: '30px' }} className="boxes1">
            <p style={{ marginLeft: '-30px', fontSize: '20px', fontWeight: '600', textAlign: 'center', paddingTop: '10px' }}>
        ...
        <div className="Chapters">
          ...
          <div className="sides">
            <div className="side1">
              ...
              <div className="chap1">Work, Energy, and Power</div>
              <div className="chap1"> Rotational Motion</div>
              <div className="chap1">Gravitation</div>
              <div className="chap1">Properties of Bulk Matter</div>
            ...
            <div className="side2">
              ...
              <div className="chap1">Current Electricity</div>
    ...
    <li><strong>Waves</strong>: Examination of wave phenomena, including sound waves, their properties, and behavior.</li>
    ...
    <li><strong>Modern Physics</strong>: Introduction to concepts in modern physics, including quantum mechanics and relativity.</li>
      ...
      <div className="nextpage1" style={{ height: '600px' }}>
        <h1 style={{ marginLeft: '-400px' }}>PDF Viewer</h1>
        ...
        <div className="ques" style={{ display: 'flex' }}>
          ...
          <div className="three" style={{ marginTop: '10px' }}>
            <div className="boxes1" style={{ width: '300px', height: '120px', marginLeft: '20px' }}>
              <p style={{ fontSize: '20px', fontWeight: '600', textAlign: 'center', paddingTop: '10px', marginLeft: '-100px' }}>NEB CLASS - XI</p>
              <p style={{ fontSize: '16px', fontWeight: '600', paddingLeft: '22px', paddingRight: '20px', marginTop: '-15px' }}>Physics Question Papers</p>
              <p style={{ fontSize: '11px', marginTop: '-10px', paddingLeft: '24px', paddingRight: '20px' }}>Here you can find most repeated questions in the exam. First Terminal, Second Terminal...</p>
              <p style={{ fontSize: '9px', paddingLeft: '24px', marginTop: '-4px' }}>Batch - 2081</p>
            </div>
            <div className="boxes1" style={{ width: '300px', height: '120px', marginLeft: '20px', marginTop: '30px' }}>
              <p style={{ fontSize: '20px', fontWeight: '600', textAlign: 'center', paddingTop: '10px', marginLeft: '-100px' }}>NEB CLASS - XI</p>
              <p style={{ fontSize: '16px', fontWeight: '600', paddingLeft: '22px', paddingRight: '20px', marginTop: '-15px' }}>Current News NEB</p>
              <p style={{ fontSize: '11px', marginTop: '-10px', paddingLeft: '24px', paddingRight: '20px' }}>Here you can find most repeated questions in the exam. First Terminal, Second Terminal...</p>
              <p style={{ fontSize: '9px', paddingLeft: '24px', marginTop: '-4px' }}>Batch - 2081</p>
            </div>
            <div className="boxes1" style={{ width: '300px', height: '120px', marginLeft: '20px', marginTop: '30px' }}>
              <p style={{ fontSize: '20px', fontWeight: '600', textAlign: 'center', paddingTop: '10px', marginLeft: '-100px' }}>NEB CLASS - XI</p>
              <p style={{ fontSize: '16px', fontWeight: '600', paddingLeft: '22px', paddingRight: '20px', marginTop: '-15px' }}>Practice Questions</p>
              <p style={{ fontSize: '11px', marginTop: '-10px', paddingLeft: '24px', paddingRight: '20px' }}>Here you can find most repeated questions in the exam. First Terminal, Second Terminal...</p>
              <p style={{ fontSize: '9px', paddingLeft: '24px', marginTop: '-4px' }}>Batch - 2081</p>
            </div>
          </div>
        </div>
        <p style={{ fontSize: '18px', fontWeight: '500', marginLeft: '30px' }}>Maintain the view of PDF according to your comfort.</p>
