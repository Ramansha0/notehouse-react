    ...
    <div>
      ...
      <div id="contact-page" className="contact-panel">
        <div className="photo1">
          ...
          <div className="bross">
            <div><i className="fa-solid fa-phone"></i><p>+977 9862573214</p></div>
            <div><i className="fa-brands fa-telegram"></i><p>Raman Shah</p></div>
            <div><i className="fab fa-facebook"></i><p>Notes House</p></div>
            <div><i className="fa-solid fa-envelope"></i><p>ramanshah440@gmail.com</p></div>
          </div>
        </div>
